...
az aks create -n aks-cluster -g rg-aks-cluster --network-plugin azure --network-plugin-mode overlay --network-dataplane cilium -k 1.34 --node-vm-size standard_d4ads_v6 --os-sku Ubuntu --node-osdisk-type Ephemeral --node-osdisk-size 64 --enable-apiserver-vnet-integration
