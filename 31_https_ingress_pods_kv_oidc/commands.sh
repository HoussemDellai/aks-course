...
az aks addon update -g $RG -n $AKS -a azure-keyvault-secrets-provider --enable-secret-rotation --rotation-poll-interval 2m
...
openssl req -x509 -nodes -days 365 -newkey rsa:2048 \
    ...
    -subj "/CN=aks-app-07.westeurope.cloudapp.azure.com/O=aks-ingress-tls" \
    -addext "subjectAltName = DNS:aks-app-07.westeurope.cloudapp.azure.com" # added by reco
...
az identity federated-credential create -n $FEDERATED_IDENTITY_NAME --identity-name $IDENTITY_NAME -g $RG --issuer $AKS_OIDC_ISSUER --subject system:serviceaccount:$NAMESPACE_APP:$SERVICE_ACCOUNT_NAME
# {
#   "audiences": [
