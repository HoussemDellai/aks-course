...
resource "azurerm_cdn_frontdoor_origin" "origin-aks-ingress" {
  ...
  private_link {
    private_link_target_id = "/subscriptions/38977b70-47bf-4da5-a492-88712fce8725/resourceGroups/mc_rg-aks-frontdoor-240_aks-cluster_swedencentral/providers/Microsoft.Network/privateLinkServices/pls-aks-ingress"
